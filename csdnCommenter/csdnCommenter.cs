...
namespace experiment
{
    class csdnCommenter
    {
        ...
        private void GoToEditPage()
        {
            ...
            if (!dbCsdnCommenter.bRandon && m_articleInfo.readCount < m_MinReadCount)
            {
        ...
        {
            dbCsdnCommenter objDB = new dbCsdnCommenter("ObjectBackup.db");
            dbCsdnCommenter.ObjectInfo backupObj = objDB.GetBackupObj();
            if (backupObj == null)
            {
