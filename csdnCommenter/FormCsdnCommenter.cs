...
{
    public partial class FormCsdnCommenter : Form
    {
        csdnCommenter m_blogRobot = null;

        public FormCsdnCommenter()
        {
            InitializeComponent();
            ...
            m_blogRobot = new csdnCommenter(webBrowser1, timerRobotBrain);
        }
