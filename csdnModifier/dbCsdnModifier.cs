...
namespace experiment
{
    class dbCsdnModifier
 {
        ...
        public dbCsdnModifier(string dbName)
        {
            connStr += dbName;
        }
        ...
        public WorkingObjectInfo GetWorkingObjectInfo()
        {
            ...
            {
                // https://blog.csdn.net/qq_44884269/article/list?
                info.lastListPageUrl = @"https://blog.csdn.net/" + info.userName + @"/article/list";
        ...
        public void SetObjDone(long id)
        {
            ...
            {
                Log.WriteLog(LogType.SQL, "SetObjDone error. sql is " + sql);
            }
        }
