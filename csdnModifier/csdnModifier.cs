...
namespace experiment
{
    class csdnModifier
    {
        ...
        dbCsdnModifier m_DataManagerSqlLite = null;
        dbCsdnModifier.WorkingObjectInfo m_workingObjectInfo;
        ...
        public csdnModifier(CsdnBrowser w, Timer timerBrain)
        {
            m_DataManagerSqlLite = new dbCsdnModifier("workingObject.db");
        ...
        {
            dbCsdnModifier objDB = new dbCsdnModifier("ObjectBackup.db");
            dbCsdnModifier.ObjectInfo backupObj = objDB.GetBackupObj();
            if (backupObj == null)
            {
