...
namespace experiment
{
    class ttBlogRobot
    {
        ...
        Timer m_timerBrain;
        ttBrowser m_browser = null;
        ttDb m_DataManagerSqlLite = null;
        ttDb.WorkingObjectInfo m_workingObjectInfo;
        ...
        public ttBlogRobot(ttBrowser w, Timer timerBrain)
        {
            m_DataManagerSqlLite = new ttDb("workingObject-cn.db");
        ...
        {
            ttDb objDB = new ttDb("ObjectBackup-cn.db");
            ttDb.ObjectInfo backupObj = objDB.GetBackupObj();
            if (backupObj == null)
            {
