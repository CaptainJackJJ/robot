...
<p>再分享一下我老师大神的人工智能教程吧。零基础！通俗易懂！风趣幽默！还带黄段子！希望你也加入到我们人工智能的队伍中来！<a href=""https://www.cnblogs.com/captainbed/p/10013538.html"">https://www.cnblogs.com/captainbed</a></p>";
        ...
        protected class WebBrowserSiteEx : WebBrowserSite, NativeMethods.IOleCommandTarget
        {
            ...
            /// Default constructor.
            /// </summary>
            public WebBrowserSiteEx(ttBrowser webBrowser)
                : base(webBrowser)
            {
            }
        ...
        public void Edit(ttBlogRobot.ArticleInfo articleInfo)
        {
        ...
        public ttBlogRobot.ArticleInfo GetArticleInfo()
        {
            ttBlogRobot.ArticleInfo info = new ttBlogRobot.ArticleInfo();
            ...
            foreach (HtmlElement ele in collection)
            {
                if (ele.OuterHtml.Contains("阅读数"))
                {
                    ...
                    if (info.readCount < ttBlogRobot.m_MinReadCount)
                        return info;
                    else
                        break;
                }
